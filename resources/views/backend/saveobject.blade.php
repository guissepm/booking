<!--
|--------------------------------------------------------------------------
| resources/views/backend/saveobject.blade.php *** Copyright netprogs.pl | avaiable only at Udemy.com | further distribution is prohibited  ***
|--------------------------------------------------------------------------
-->
...
<form {{ $novalidate /* Lecture 44 */}} method="POST" enctype="multipart/form-data" class="form-horizontal" action="{{ route('saveObject',['id'=>$object->id ?? null]) /* Lecture 44 */ }}">
    <fieldset>
        ...
        <div class="col-lg-10 col-lg-offset-2">
            ...
            @foreach( $object->photos->chunk(4) as $chunked_photos ) <!-- Lecture 44 -->

                <div class="row">


                    @foreach( $chunked_photos as $photo ) <!-- Lecture 44 -->

                        <div class="col-md-3 col-sm-6">
                            <div class="thumbnail">
                                <img class="img-responsive" src="{{ $photo->path ?? $placeholder /* Lecture 44 */ }}" alt="...">
                                <div class="caption">
                                    <p><a href="{{ route('deletePhoto',['id'=>$photo->id]) /* Lecture 44 */ }}" class="btn btn-primary btn-xs" role="button">Delete</a></p>
                                </div>
