...
/*
|--------------------------------------------------------------------------
| app/Listeners/ReservationConfirmedListener.php *** Copyright netprogs.pl | avaiable only at Udemy.com | further distribution is prohibited  ***
|--------------------------------------------------------------------------
*/
...
class ReservationConfirmedListener
{
    ...
    public function handle(ReservationConfirmedEvent $event)
    {
        ...
        $memcache = new \Memcached(); /* Lecture 54 11211*/
