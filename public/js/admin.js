/*
|--------------------------------------------------------------------------
| resources/assets/js/admin.js *** Copyright netprogs.pl | avaiable only at Udemy.com | further distribution is prohibited  ***
|--------------------------------------------------------------------------
*/
...
var App = {
    ...
    GetReservationData: function GetReservationData(id, calendar_id /* Lecture 32 */, date) {
